...
func (reconciler *OpenldapReconciler) defineServiceHeadLess(openldap *servicesv1alpha1.Openldap) *v1.Service {
	...
	service := &v1.Service{
		...
		ObjectMeta: metav1.ObjectMeta{
			Name:      variables.ServiceNameHeadLess,
...
func (reconciler *OpenldapReconciler) reconcileServiceHeadLess(ctx context.Context, openldap *servicesv1alpha1.Openldap) (ctrl.Result, error) {
